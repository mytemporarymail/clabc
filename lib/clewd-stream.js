/*
* https://gitgud.io/ahsk/clabc
* https://github.com/h-a-s-k/clabc
*/
'use strict';

const {AI, genericFixes, DangerChars, encodeDataJSON, indexOfAny, cleanJSON, checkResErr} = require('./clabc-utils'), Decoder = new TextDecoder;

class clabcStream extends TransformStream {
